...
<head>
    ...
    <link href="/resources/assets/css/pages/error/error-5.css" rel="stylesheet" type="text/css"/>
...
<div class="d-flex flex-column flex-root">
    <!--begin::Error-->
    <div class="error error-5 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url(/resources/assets/media/error/bg5.jpg);">
        <!--begin::Content-->
        <div class="container d-flex flex-row-fluid flex-column justify-content-md-center p-12">
            ...
            <p class="font-size-h3">서비스에 불편을 드려서 죄송합니다!</p>
            <p class="font-size-h3">메인페이지 접속을 다시 하거나, 고객센터로 문의주시길 바랄게요!</p>
        </div>
        <!--end::Content-->
    </div>
    <!--end::Error-->
