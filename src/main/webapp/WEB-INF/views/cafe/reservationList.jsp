<%-- 스터디 카페 예약 리스트 화면단 User: 신지혜 Date: 2021-11-25 Time: 오전 6:13 To change this template use File | Settings | File
    Templates. --%>
					...
					<div class="subheader py-2 py-lg-6" id="kt_subheader">
						...
						<div class="w-100 d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
							...
							<div class="d-flex align-items-center flex-wrap mr-1">
								<!--begin::Title-->
								<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">예약내역 조회
								</h5>
								<!--end::Title-->
								<!--begin::Separator-->
							...
							<div class="d-flex align-items-center">
								<!--begin::Button-->
								<a onclick="history.back();" class="btn btn-default font-weight-bold">뒤로가기</a>
							</div>
							<!--end::Toolbar-->
						</div>
						<!--end::Subheader-->
							...
							<div class="card-header flex-wrap border-0 pt-6 pb-0">
								...
								<div class="card-body">
									<h3 class="card-label">예약내역 확인하기
										<span class="d-block text-muted pt-2 font-size-sm mb-20">예약
                                                                    내역과 해당하는 거래내역 조회가 가능합니다.</span>
									</h3>
									<!--begin: Search Form-->
									<!--begin::Search Form-->
									<div class="mb-7">
														...
														<div class="d-flex align-items-center">
															...
															<div class="dropdown bootstrap-select form-control">
																...
																<div class="dropdown-menu">
																	<div class="inner show" role="listbox" id="bs-select-1" tabindex="-1" aria-activedescendant="bs-select-1-0">
																		<ul class="dropdown-menu inner show" role="presentation">
																			<li class="selected active">
																				<a role="option" class="dropdown-item active selected" id="bs-select-1-0" tabindex="0" aria-setsize="7" aria-posinset="1" aria-selected="true"><span
																						class="text">All</span></a>
																			</li>
																			<li><a role="option" class="dropdown-item" id="bs-select-1-1" tabindex="0" aria-setsize="7" aria-posinset="2"><span
																					class="text">이용대기</span></a>
																			</li>
																			<li><a role="option" class="dropdown-item" id="bs-select-1-2" tabindex="0" aria-setsize="7" aria-posinset="3"><span
																					class="text">이용완료</span></a>
																			</li>
																			<li><a role="option" class="dropdown-item" id="bs-select-1-3" tabindex="0" aria-setsize="7" aria-posinset="3"><span
																					class="text">취소완료</span></a>
																			</li>
																		</ul>
																	</div>
																</div>
									...
									<!--begin: Datatable-->
									<div class="datatable datatable-bordered datatable-head-custom datatable-default
                    datatable-primary datatable-subtable datatable-loaded" id="rsrvTable">
										...
										<table class="datatable-table">
											...
											<tr class="datatable-row">
												...
												<th data-field="ReservationID" class="datatable-cell ">
													<span style="">예약번호</span>
												</th>
												<th data-field="CafeInfo" class="datatable-cell ">
													<span style="">예약공간</span>
												</th>
												<th data-field="ReservationAmount" class="datatable-cell ">
													<span style="">결제금액</span>
												</th>
												<th data-field="UseDateInfo" class="datatable-cell ">
													<span style="">이용일자</span>
												</th>
												<th data-field="Status" data-autohide-disabled="false" class="datatable-cell ">
													<span style="">상태</span>
												</th>
										...
										<div class="datatable-pager datatable-paging-loaded">
											...
											<div class="datatable-pager-info my-2 mb-sm-0">
												<div class="dropdown bootstrap-select datatable-pager-size dropup">
													<select class="selectpicker datatable-pager-size" title="Select page size" data-width="60px" data-container="body" data-selected="10" tabindex="null" id="select-pager">
...
<td data-field="Status" data-autohide-disabled="false" aria-label="` + rsrv_status_ynz + `"
        ...
        `;
            ...
            function displayData(currentPage, dataPerPage) {
                ...
                for (
                    var i = ((currentPage) - 1) * dataPerPage + 1; i <= (currentPage - 1) * dataPerPage + dataPerPage; i++
                ) {
