        ...
        $("input[name='keyword']").on("keyup", function (key) {
            ...
            if (key.keyCode == 13) {
                ...
                $(`input:checkbox[name='chk']`).each(function () {
                    if ($(this).val() == "전체") {
                        location.href = '/manager/study/list?pageNum=1&amount=20&keyword=' + $(`input[name='keyword']`).val();
                        return;
                    }
                    aa += `&chk=` + $(this).val();
                });

                location.href = '/manager/study/list?pageNum=1&amount=20&keyword=' + $(`input[name='keyword']`).val() + aa;
            }
        });
