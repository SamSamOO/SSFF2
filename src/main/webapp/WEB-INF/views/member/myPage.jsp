								...
								<div class="card-body">
									...
									<div class="studylist-nav d-inline-block w-100 mt-4 mb-4 pt-4 rounded-xl shadow">
										...
										<ul class="logo-to-sort d-flex flex-wrap justify-content-center">
											...
											<li><img src="${pageContext.request.contextPath}/resources/assets/images/logos/language/node_js.png" width="50px" onclick="logoClicked('node_js')" id="logo_node_js">
											</li>
											...
											<li><img src="${pageContext.request.contextPath}/resources/assets/images/logos/language/spring.png" width="50px" onclick="logoClicked('spring')" id="logo_spring">
											</li>
											<li><img src="${pageContext.request.contextPath}/resources/assets/images/logos/language/kotlin.png" width="50px" onclick="logoClicked('kotlin')" id="logo_kotlin">
											</li>
											...
											<li><img src="${pageContext.request.contextPath}/resources/assets/images/logos/language/python.png" width="50px" onclick="logoClicked('python')" id="logo_python">
											</li>
											<li><img src="${pageContext.request.contextPath}/resources/assets/images/logos/language/django.png" width="50px" onclick="logoClicked('django')" id="logo_django">
											</li>
											<li><img src="${pageContext.request.contextPath}/resources/assets/images/logos/language/flutter.png" width="50px" onclick="logoClicked('flutter')" id="logo_flutter">
											</li>
											<li><img src="${pageContext.request.contextPath}/resources/assets/images/logos/language/swift.png" width="50px" onclick="logoClicked('swift')" id="logo_swift">
											</li>
										</ul>
									</div>
